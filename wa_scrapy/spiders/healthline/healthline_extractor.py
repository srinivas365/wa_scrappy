...
from wa_scrapy.items import HealthlineArticleItem,HealthlineContentItem
import scrapy
...
class HealthlineExtractor(scrapy.Spider):
    ...
    custom_settings = {
        ...
        "INPUT_COLLECTION" : "healthline_html",
        "OUTPUT_COLLECTION":"healthline_articles"
    }
